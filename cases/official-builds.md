# Official Astra builds

Canonical list lives in the root README. Primary sources:

| Build | Source |
|-------|--------|
| Cell-tracking | https://openai.com/index/gpt-6-astra/ |
| KiCad `chip_design` | https://openai.com/index/gpt-6-astra/ |
